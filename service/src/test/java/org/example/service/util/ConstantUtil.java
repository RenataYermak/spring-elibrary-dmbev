...
public class ConstantUtil {
    ...
    public static final Long AUTHOR_ID_ONE = 1L;
    public static final Long AUTHOR_ID_TWO = 2L;
    public static final Integer ALL_AUTHORS = 4;
    public static final Integer ALL_2_AUTHORS = 2;
    public static final Integer CATEGORY_ID_ONE = 1;
    public static final Integer CATEGORY_ID_TWO = 2;
    public static final Integer ALL_2_CATEGORIES = 2;
